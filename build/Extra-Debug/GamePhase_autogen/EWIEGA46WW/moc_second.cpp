...
static constexpr auto qt_meta_stringdata_ZN6secondE = QtMocHelpers::stringData(
    "second",
    "on_pvpMatch_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6secondE[] = {
...
Q_CONSTINIT const QMetaObject second::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6secondE.offsetsAndSizes,
    qt_meta_data_ZN6secondE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6secondE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<second, std::true_type>,
        // method 'on_pvpMatch_clicked'
...
void second::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pvpMatch_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *second::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6secondE.stringdata0))
